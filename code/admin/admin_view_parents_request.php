...
if ($_SERVER['REQUEST_METHOD'] === 'GET' && isset($_GET['action']) && isset($_GET['id'])) {
    ...
    try {
        ...
        $update_stmt = $conn->prepare("UPDATE meal_change_requests SET status = ?, admin_notes = ? WHERE id = ?");
        $update_stmt->bind_param("ssi", $new_status, $admin_notes, $request_id);
        $update_stmt->execute();
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['reject_request'])) {
    ...
    try {
        ...
        $update_stmt = $conn->prepare("UPDATE meal_change_requests SET status = 'Rejected', admin_notes = ? WHERE id = ?");
            ...
            <div class="card-body">
                <form method="GET" class="row g-3">
                    ...
                    <div class="col-md-3 d-flex align-items-end">
                        ...
                        <a href="admin_view_parents_request.php" class="btn btn-outline-secondary filter-btn"><i class="bi bi-arrow-counterclockwise me-1"></i> Reset</a>
                    </div>
                    <div class="col-md-3 d-flex align-items-end">
                        <a href="admin_meal_schedule.php" class="btn btn-secondary filter-btn" style="white-space: nowrap;">
                                ...
                                <tr>
                                    ...
                                    <td class="action-btns">
                                        <?php if ($row['status'] === 'Pending'): ?>
                                            <a href="admin_view_parents_request.php?id=<?= $row['id'] ?>&action=approve" 
