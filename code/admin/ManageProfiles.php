...
<head>
    <meta charset="UTF-8">
    <title>Manage User Profiles - Daycare Management System</title>
<style>
    :root {
            ...
            <?php while($row = mysqli_fetch_assoc($result)): ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a class="btn delete-btn" href="delete_profile.php?id=<?= $row['id'] ?>" onclick="return confirm('Are you sure you want to delete this user?')">Delete</a>
                    </td>
                </tr>
            <?php endwhile; ?>
        <?php else: ?>
