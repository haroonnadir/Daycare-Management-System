...
<head>
    ...
    <title>Admin Dashboard | Daycare Management System</title>
...
<div class="navbar">
    ...
    <div class="user-info">
        ...
        <img src="https://ui-avatars.com/api/?name=<?= urlencode($_SESSION['name'] ?? 'Admin') ?>&background=random" alt="User">
...
<div class="sidebar" id="sidebar">
    ...
    <div class="sidebar-menu">
        <ul>
            ...
            <li>
                <a href="admin_manage_children.php" class="<?= $current_page == 'admin_manage_children.php' ? 'active' : '' ?>">
                    <i class="fas fa-child"></i> Children Management
                    <span class="badge badge-primary"><?= $stats['total_children'] ?></span>
                </a>
            </li>
            <li>
                <a href="manage_staff.php" class="<?= $current_page == 'manage_staff.php' ? 'active' : '' ?>">
                    <i class="fas fa-user-tie"></i> Staff Management
                    <span class="badge badge-primary"><?= $stats['total_staff'] ?></span>
                </a>
            </li>
            <li>
            ...
            <li>
                <a href="admin_manage_activities.php" class="<?= $current_page == 'admin_manage_activities.php' ? 'active' : '' ?>">
                    <i class="fas fa-clipboard-list"></i> Daily Activities
                </a>
            </li>
            <li>
                <a href="admin_meal_schedule.php" class="<?= $current_page == 'admin_meal_schedule.php' ? 'active' : '' ?>">
                    <i class="fas fa-utensils"></i> Meal Schedule
                </a>
            </li>
            <li>
                <a href="admin_manage_messages.php" class="<?= $current_page == 'admin_manage_messages.php' ? 'active' : '' ?>">
                    <i class="fas fa-envelope"></i> Messages
                    <span class="badge badge-primary"><?= $stats['unread_messages'] ?></span>
                </a>
            </li>
            <li>
                <a href="admin_manage_notifications.php" class="<?= $current_page == 'admin_manage_notifications.php' ? 'active' : '' ?>">
            ...
            <li>
                <a href="admin_generate_reports.php" class="<?= $current_page == 'admin_generate_reports.php' ? 'active' : '' ?>">
                    <i class="fas fa-chart-bar"></i> Invoices & Analytics
                </a>
            </li>
            <li>
                <a href="admin_manage_payments.php" class="<?= $current_page == 'admin_manage_payments.php' ? 'active' : '' ?>">
                    <i class="fas fa-file-invoice-dollar"></i> Billing & Payments
                    <span class="badge badge-danger"><?= $stats['pending_payments'] ?></span>
                </a>
            </li>
            <li>
            <li>
                <a href="AdminManageProfiles.php" class="<?= $current_page == 'AdminManageProfiles.php' ? 'active' : '' ?>">
    ...
    <div class="main-content">
        ...
        <div class="dashboard-cards">
            <a href="admin_manage_parents.php" class="dashboard-card">
            ...
            <a href="admin_manage_children.php" class="dashboard-card">
                <div class="card-header">
                    <div>
            ...
            <a href="admin_manage_staff.php" class="dashboard-card">
                <div class="card-header">
                    <div>
                        <div class="card-value"><?= $stats['total_staff'] ?></div>
            ...
            <a href="admin_manage_payments.php" class="dashboard-card">
                <div class="card-header">
                    <div>
            ...
            <a href="admin_manage_messages.php" class="dashboard-card">
                <div class="card-header">
                    <div>
            ...
            <a href="admin_manage_tasks.php" class="dashboard-card">
                <div class="card-header">
                    <div>
        ...
        <div class="section-card">
            ...
            <div class="quick-actions">
                ...
                <a href="admin_manage_notifications.php" class="quick-action">
                    <i class="fas fa-bullhorn"></i>
                    <span>Send Notification</span>
                </a>
                <a href="admin_manage_invoices.php" class="quick-action">
