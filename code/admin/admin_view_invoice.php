...
if (!isset($_GET['id']) || !is_numeric($_GET['id'])) {
    header("Location: admin_invoices.php?error=Invalid invoice ID");
    exit();
}
...
try {
    ...
    if (!$invoice) {
        header("Location: admin_invoices.php?error=Invoice not found");
        exit();
    }
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['send_reminder'])) {
    ...
    if ($sendCopy) {
        $notificationSystem->createNotification(
            ...
            $invoice['parent_name'],
            "admin_view_invoice.php?id={$invoiceId}"
        );
    }
...
<body>
    <div class="container py-5">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="admin_manage_invoices.php" class="btn btn-secondary">
        ...
        <div class="row mt-4">
            <div class="col-md-6">
                <a href="admin_edit_invoice.php?id=<?= $invoiceId ?>" class="btn btn-primary me-2">
                    <i class="fas fa-edit"></i> Edit Invoice
                </a>
                <!-- <?php if ($balance > 0): ?>
                <a href="admin_record_payment.php?invoice_id=<?= $invoiceId ?>" class="btn btn-success">
