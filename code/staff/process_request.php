...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['reject_request'])) {
        ...
        try {
            ...
            $update_stmt = $conn->prepare("UPDATE meal_change_requests SET status = 'Rejected', staff_notes = ?, reviewed_by = ?, reviewed_at = NOW() WHERE id = ?");
    ...
    try {
        ...
        $update_status = $conn->prepare("UPDATE meal_change_requests SET status = 'Approved', staff_notes = 'Approved by staff', reviewed_by = ?, reviewed_at = NOW() WHERE id = ?");
            ...
            <div class="card-body">
                <form method="GET" class="row g-3">
                    ...
                    <div class="col-md-3 d-flex align-items-end">
                        ...
                        <a href="staff_view_parents_request.php" class="btn btn-outline-secondary"><i class="bi bi-arrow-counterclockwise"></i> Reset</a>
                    </div>
                </form>
            </div>
        </div>
