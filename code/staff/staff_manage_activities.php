...
if (isset($_GET['action'])) {
    ...
    header("Location: staff_manage_activities.php?date=" . $selected_date);
    exit();
}
        ...
        <div class="date-navigation card mb-4">
            <div class="card-body d-flex justify-content-between align-items-center">
                <div class="date-controls">
                    <a href="staff_manage_activities.php?action=prev&date=<?= $selected_date ?>" class="btn btn-primary">
                        <i class="fas fa-chevron-left"></i> Previous Day
                    </a>
                    <a href="staff_manage_activities.php?action=today" class="btn btn-secondary mx-2">
                        Today
                    </a>
                    <a href="staff_manage_activities.php?action=next&date=<?= $selected_date ?>" class="btn btn-primary">
