        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    ...
                    <h1 class="h2"><a href="staff_dashboard.php">go back dashboard</a></h1>
                                ...
                                <tbody>
                                    <?php foreach ($invoices as $invoice): ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="staff_view_invoice.php?id=<?= $invoice['id'] ?>" class="btn btn-sm btn-info">
                                                    <i class="fas fa-eye"></i> View
                                                </a>
                                                <a href="staff_edit_invoice.php?id=<?= $invoice['id'] ?>" class="btn btn-sm btn-warning">
