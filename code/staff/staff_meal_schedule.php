...
if (isset($_GET['action'])) {
    ...
    header("Location: staff_meal_schedule.php?date=" . $week_start->format('Y-m-d'));
    exit();
}
...
<!-- Header Section -->
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex gap-2">
            <button class="btn btn-outline-primary">
                <a href="staff_view_parents_request.php" class="text-decoration-none">
    ...
    <div class="week-navigation d-flex justify-content-between align-items-center mb-4">
        ...
        <form method="POST" action="staff_meal_schedule.php">
            ...
            <div class="d-flex justify-content-between mt-3">
                <div>
                    <a href="staff_view_parents_request.php" class="btn btn-outline-secondary">
                        <i class="fas fa-users me-1"></i> View Parent Requests
                    </a>
                </div>
                <div>
